...
public:
	...
	static CString GetStringMD5(LPCTSTR lpInput);	
	static CString GetFileMD5(const CString& strFilePath);
	static CString GetBlockMD5(const BYTE* pBuf, UINT nLength);
...
protected:
	...
	//utility functions
	void DWordToByte(BYTE* Output, const DWORD* Input, UINT nLength);
	void ByteToDWord(DWORD* Output, const BYTE* Input, UINT nLength);
